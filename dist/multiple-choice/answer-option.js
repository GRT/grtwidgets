...
class AnswerOption extends React.Component {
  ...
  getRadio() {
    return this.state.selected ? React.createElement('img', { style: _.merge(styles.radio, styles.check), src: Check }) : React.createElement('div', { style: styles.radio });
  }
  ...
  render() {
    ...
    return React.createElement(
      'div',
      { style: styles.option, onClick: this.clickHandler },
      this.getRadio(),
      React.createElement(
        'span',
        { style: styles.label },
        _.get(this, 'props.answer')
      )
    );
  }
}
